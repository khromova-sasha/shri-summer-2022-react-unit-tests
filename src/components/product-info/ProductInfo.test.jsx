...
describe('Компонент ProductInfo', () => {
    ...
    it('Не отображать старую цену, если undefined', () => {
        render(<ProductInfo bouquetHeight={10} bouquetWidth={10} currentPrice={100}
    ...
    it("Не отображать старую цену, если null", () => {
        render(<ProductInfo bouquetHeight={10} bouquetWidth={10} currentPrice={100}
    ...
    it("Не отображать старую цену, если 0", () => {
    ...
    it('Не отображать количество цветов, если undefined', () => {
        render(<ProductInfo bouquetHeight={10} bouquetWidth={10} currentPrice={100}
    ...
    it("Не отображать количество цветов, если null", () => {
    ...
    it("Не отображать количество цветов, если 0", () => {
    ...
    it('Не отображать высоту букета, если undefined', () => {
    ...
    it("Не отображать высоту букета, если null", () => {
    ...
    it("Не отображать высоту букета, если 0", () => {
    ...
    it('Не отображать ширину букета, если undefined', () => {
    ...
    it("Не отображать ширину букета, если null", () => {
    ...
    it("Не отображать ширину букета, если 0", () => {
